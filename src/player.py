        ...
        while not pawn_selected:
            ...
            while not coordinate_selected:
                try:
                    ...
                    print("Enter Input in the proper format")
            pawn_chain_capture_coordinates = board.move_pawn(board.p2_pawns[player_pawn_choice],
                    ...
                    try:
                        ...
                        if chain_capture == 1:
                            ...
                            if len(pawn_chain_capture_coordinates) >= chain_capture_coordinate_choice > 0:
                                proper_input = True
                                board.move_pawn(board.p2_pawns[player_pawn_choice],
